...
func main() {
	...
	/*	xiaomiPush, err := s.PushXiaomiPush(&push.XiaomiPushReq{
			Key:     "jiachao_xiaomi",
			Msg:     "test",
			IsDebug: false,
			Token: []string{
				"Tr16cOqD6FebMZuKZxweFIKLmysES00/0E1K+wJ2sV7szzQBwbMbx+Wsisy8LJ0o",
			},
			Type:   "web",
	...
	huaweiPush, err := s.PushHuaweiPush(&push.HuaweiPushReq{
		Key:     "jiachao_huawei",
		Msg:     "test",
		IsDebug: false,
		Token: []string{
